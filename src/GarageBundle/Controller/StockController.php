...
class StockController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $stocks = $em->getRepository('GarageBundle:Stock')->findAll();
    ...
    {
        $stock = new Stock();
        $form = $this->createForm('GarageBundle\Form\StockType', $stock);
    ...
    {
        $deleteForm = $this->createDeleteForm($stock);
        $editForm = $this->createForm('GarageBundle\Form\StockType', $stock);
