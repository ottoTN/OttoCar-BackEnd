...
use GarageBundle\Entity\Notification;
...
class NotificationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $notifications = $em->getRepository('GarageBundle:Notification')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('GarageBundle\Form\NotificationType', $notification);
    ...
    {
        $deleteForm = $this->createDeleteForm($notification);
        $editForm = $this->createForm('GarageBundle\Form\NotificationType', $notification);
